...
#twitterStream.filter(track=['ecuador', 'loja', 'cuenca', 'ibarra'])
twitterStream.filter(track=['MashiRafael', 'EcuadorPluricultural', 'FiestaDeLaLuz', 'PueblosIndigenas', 'ecuador', 'loja', 'cuenca', 'ibarra'])
